...
import 'package:jogodavelha/features/jogo_da_velha/presentation/controllers/room_data_provider.dart';
  ...
  void checkWinner(BuildContext context, Socket socketClent) {
    ...
    if (winner != '') {
      if (roomDataProvider.player1.playerType == winner) {
        showGameDialog(context, '${roomDataProvider.player1.nickname} venceu!');
        socketClent.emit('winner', {
          'winnerSocketId': roomDataProvider.player1.socketID,
          'roomId': roomDataProvider.roomData['_id'],
        });
      } else {
        showGameDialog(context, '${roomDataProvider.player2.nickname} venceu!');
        socketClent.emit('winner', {
